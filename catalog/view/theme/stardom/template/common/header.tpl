								...
								<div class="row">
									...
									<div class="col-sm-8" id="top-bar-right">
										...
										<ul class="header-links">
											...
											<li class="check_ic"><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></li>
										</ul>
									</div>
									...
									<div class="col-sm-4 hidden-xs">
										...
										<div class="welcome-text">
											<?php if($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) ) != '') { echo html_entity_decode($theme_options->get( 'welcome_text', $config->get( 'config_language_id' ) )); } else { echo 'Call us: +1800 200-563-563'; } ?>
										</div>
                                        
                                        <div class="social_links">
                                        <ul>
                                        <li><a href="#"><img src="catalog/view/theme/stardom/img/fb_ic.png"/></a></li>
                                        <li><a href="#"><img src="catalog/view/theme/stardom/img/twt_ic.png"/></a></li>
                                        <li><a href="#"><img src="catalog/view/theme/stardom/img/g_ic.png"/></a></li>
                                        <li><a href="#"><img src="catalog/view/theme/stardom/img/p_ic.png"/></a></li>
                                        </ul>
